...
<html>
	<head>
		<title>Bem-vindo à Komfort House | Sofás - Sofas e Poltronas em São Paulo</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf8" />
		...
		<!-- ==========ATTACH ALL LINKS=========== -->
			...
			<link rel="shortcut icon" href="image/favicon.ico" type="image/x-icon">
             ...
             <!-- ==========ATTACH DESCRIPTION=========== -->
            <meta name="description" content="Seja bem-vindo à Komfort House. Veja todos os diferenciais da maior rede de loja de sofás e poltronas do país. Ofertas especiais e produtos criteriosamente selecionados para você.
">
						...
						<div class="right-side pull-right text-right">
							...
							<div class="search-box">
								<div class="input-group">
									...
									<input type="text" id="searchmeinput" onKeyUp="searchpro(this.value);" class="form-control" placeholder="Qual tipo de sof&aacute; voc&ecirc; procura? Cique aqui e fa&ccedil;a sua pesquisa" style="height:27px;" value="">
						...
						<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						 ...
						 <!--   <li data-target="#carousel-example-generic" data-slide-to="1"></li>
						  ...
						  <div class="carousel-inner carousel_inner">
						    ...
						    <a href="http://www.komforthouse.com.br/lojas-komfort-house-sofas.php"> <img src="admin/upload_image/general_images/20497792komfort-house-a-maior-do-brasil.jpg" alt="..." class="img-responsive" width="100%"></a>
						    ...
						    <a href="http://etrom.com.br/komfort/detalhes-sofas-poltronas-komfort-house.php?id=57"> <img src="admin/upload_image/general_images/85267332komfort-house-banner-paris.jpg" alt="..." class="img-responsive" width="100%"></a>
						    ...
						    <a href="http://etrom.com.br/komfort/detalhes-sofas-poltronas-komfort-house.php?id=86"> <img src="admin/upload_image/general_images/6690612komfort-house-banner-sofa-cama-barcelona.jpg" alt="..." class="img-responsive" width="100%"></a>
						    ...
						    <a href="http://etrom.com.br/komfort/detalhes-sofas-poltronas-komfort-house.php?id=89"> <img src="admin/upload_image/general_images/38090277komfort-house-banner-sofa-de-canto-miami.jpg" alt="..." class="img-responsive" width="100%"></a>
						    ...
						    <a href="http://etrom.com.br/komfort/detalhes-sofas-poltronas-komfort-house.php?id=63"> <img src="admin/upload_image/general_images/85200131komfort-house-banner-sofa-roma.jpg" alt="..." class="img-responsive" width="100%"></a>
						    ...
						    <a href="http://etrom.com.br/komfort/lojas-komfort-house-sofas.php"> <img src="admin/upload_image/general_images/83893329banner-10-lojas.jpg" alt="..." class="img-responsive" width="100%"></a>
...
<div class="bread">
			<div class="container">
				<div class="row">
					<div class="col-md-12">					
						<a href="index.php">Destaques Komfort House</a>	
        ...
        <!--video-->
        <div class="quality" style="padding:10px 0 10px;">
			<div class="container">
				<div class="row">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
						<div class="qu-img">
						                            ...
						                            <iframe width="100%" height="250" src="https://www.youtube.com/embed/8v3lXv3lAzM?rel=0" frameborder="0" allowfullscreen></iframe>
							                        </div>	
					</div>

					<div class="col-md-7 col-sm-7 col-xs-12">
						<div class="qu-content">
							<h2 class=""><span class="greyclr">A Qualidade </span><span>Komfort House</span></h2>

							<p>Seja bem-vindo à Komfort House Sofás. Aqui você encontrará produtos totalmente selecionados, seguindo os mais criteriosos padrões de qualidade e bom gosto. <br /><br />
Aproveite e confira nosso novo comercial, com ofertas imperdíveis!<br /><br />
Komfort House - Uma casa só é completa com um bom sofá!</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="home-content">	
			<div class="container">	
				<div class="row">
							...
							<div class="col-md-3 col-sm-6 col-xs-12 space10" mycnt="1">
								<div class="item">
                                <h3>Promoção Sofá Cairo<br /><br /></h3>
                                    <div class="image">
                                        
                                       <!--  <img src="admin/upload_image/general_images/" class="mautomargin img-responsive" alt="Owl Image"> -->

                                         <img src="admin/upload_image/general_images/6297887komfort-house-sofas-poltronas-cairo-05.jpg" class="mautomargin img-responsive" alt="Owl Image">
                                    
                                        <div class="overlay">
                                            <div class="overlay-content text-center">
                                                <h4 class="whiteclr">De R$ 1.900,00 por<br>só 10 x de R$ 89,90</h4>	
                                                
                                                <a href="detalhes-sofas-poltronas-komfort-house.php?id=33"  class=" whiteclr">
                                                    <div  class="plus text-right">
                                                        <span class="fsize18">saiba</span><span class="fsize16"><i class="fa fa-plus "></i></span>
                                                    </div>
                                                </a>		
                                            </div>
                                        </div>
							...
							<div class="col-md-3 col-sm-6 col-xs-12 space10" mycnt="2">
								<div class="item">
                                <h3>Promoção Sofá Madri<br /><br /></h3>
                                    <div class="image">
                                        
                                       <!--  <img src="admin/upload_image/general_images/" class="mautomargin img-responsive" alt="Owl Image"> -->

                                         <img src="admin/upload_image/general_images/66070547komfort-house-sofas-poltronas-madri.jpg" class="mautomargin img-responsive" alt="Owl Image">
                                    
                                        <div class="overlay">
                                            <div class="overlay-content text-center">
                                                <h4 class="whiteclr">De R$ 2.000,00 por<br>só 10 x de R$ 99,90</h4>	
                                                
                                                <a href="detalhes-sofas-poltronas-komfort-house.php?id=54"  class=" whiteclr">
                                                    <div  class="plus text-right">
                                                        <span class="fsize18">saiba</span><span class="fsize16"><i class="fa fa-plus "></i></span>
                                                    </div>
                                                </a>		
							...
							<div class="col-md-3 col-sm-6 col-xs-12 space10" mycnt="3">
								<div class="item">
                                <h3>Promoção Sofá Retrátil<br />Berlin</h3>
                                    <div class="image">
                                        
                                       <!--  <img src="admin/upload_image/general_images/" class="mautomargin img-responsive" alt="Owl Image"> -->

                                         <img src="admin/upload_image/general_images/71196753komfort-house-sofas-poltronas-berlin-06.jpg" class="mautomargin img-responsive" alt="Owl Image">
                                    
                                        <div class="overlay">
                                            <div class="overlay-content text-center">
                                                <h4 class="whiteclr">De R$ 3.000,00 por<br>só 10 x de *R$ 179,90</h4>	
                                                
                                                <a href="detalhes-sofas-poltronas-komfort-house.php?id=32"  class=" whiteclr">
                                                    <div  class="plus text-right">
                                                        <span class="fsize18">saiba</span><span class="fsize16"><i class="fa fa-plus "></i></span>
                                                    </div>
                                                </a>		
							...
							<div class="col-md-3 col-sm-6 col-xs-12 space10" mycnt="4">
								<div class="item">
                                <h3>Promoção Sofá Retrátil<br />Mark</h3>
                                    <div class="image">
                                        
                                       <!--  <img src="admin/upload_image/general_images/" class="mautomargin img-responsive" alt="Owl Image"> -->

                                         <img src="admin/upload_image/general_images/35046799komfort-house-sofas-poltronas-mark-003.jpg" class="mautomargin img-responsive" alt="Owl Image">
                                    
                                        <div class="overlay">
                                            <div class="overlay-content text-center">
                                                <h4 class="whiteclr">De R$ 4.000,00 por<br>só 10 x de *R$ 199,90</h4>	
                                                
                                                <a href="detalhes-sofas-poltronas-komfort-house.php?id=55"  class=" whiteclr">
                                                    <div  class="plus text-right">
                                                        <span class="fsize18">saiba</span><span class="fsize16"><i class="fa fa-plus "></i></span>
                                                    </div>
                                                </a>		
							...
							<div class="col-md-3 col-sm-6 col-xs-12 space10" mycnt="5">
								<div class="item">
                                <h3>Promoção Sofá Paris<br /><br /></h3>
                                    <div class="image">
                                        
                                       <!--  <img src="admin/upload_image/general_images/" class="mautomargin img-responsive" alt="Owl Image"> -->

                                         <img src="admin/upload_image/general_images/43910243komfort-house-sofas-poltronas-paris-02.jpg" class="mautomargin img-responsive" alt="Owl Image">
                                    
                                        <div class="overlay">
                                            <div class="overlay-content text-center">
                                                <h4 class="whiteclr">De R$ 2.000,00 por<br>só 10 x de R$ 89,90</h4>	
                                                
                                                <a href="detalhes-sofas-poltronas-komfort-house.php?id=57"  class=" whiteclr">
                                                    <div  class="plus text-right">
                                                        <span class="fsize18">saiba</span><span class="fsize16"><i class="fa fa-plus "></i></span>
                                                    </div>
                                                </a>		
							...
							<div class="col-md-3 col-sm-6 col-xs-12 space10" mycnt="6">
								<div class="item">
                                <h3>Promoção Sofá Cama<br />Barcelona</h3>
                                    <div class="image">
                                        
                                       <!--  <img src="admin/upload_image/general_images/" class="mautomargin img-responsive" alt="Owl Image"> -->

                                         <img src="admin/upload_image/general_images/2131652komfort-house-sofas-poltronas-barcelona-04.jpg" class="mautomargin img-responsive" alt="Owl Image">
                                    
                                        <div class="overlay">
                                            <div class="overlay-content text-center">
                                                <h4 class="whiteclr">De R$ 2.000,00 por<br>só 10 x de R$ 99,90</h4>	
                                                
                                                <a href="detalhes-sofas-poltronas-komfort-house.php?id=86"  class=" whiteclr">
                                                    <div  class="plus text-right">
                                                        <span class="fsize18">saiba</span><span class="fsize16"><i class="fa fa-plus "></i></span>
                                                    </div>
                                                </a>		
							...
							<div class="col-md-3 col-sm-6 col-xs-12 space10" mycnt="7">
								<div class="item">
                                <h3>Promoção Sofá de Canto<br />Miami</h3>
                                    <div class="image">
                                        
                                       <!--  <img src="admin/upload_image/general_images/" class="mautomargin img-responsive" alt="Owl Image"> -->

                                         <img src="admin/upload_image/general_images/38186164komfort-house-sofas-poltronas-miami-001.jpg" class="mautomargin img-responsive" alt="Owl Image">
                                    
                                        <div class="overlay">
                                            <div class="overlay-content text-center">
                                                <h4 class="whiteclr">De R$ 3.000,00 por <br>só 10 x de R$ 179,90</h4>	
                                                
                                                <a href="detalhes-sofas-poltronas-komfort-house.php?id=89"  class=" whiteclr">
                                                    <div  class="plus text-right">
                                                        <span class="fsize18">saiba</span><span class="fsize16"><i class="fa fa-plus "></i></span>
                                                    </div>
                                                </a>		
							...
							<div class="col-md-3 col-sm-6 col-xs-12 space10" mycnt="8">
								<div class="item">
                                <h3>Promoção Sofá Roma<br /><br /></h3>
                                    <div class="image">
                                        
                                       <!--  <img src="admin/upload_image/general_images/" class="mautomargin img-responsive" alt="Owl Image"> -->

                                         <img src="admin/upload_image/general_images/19014044komfort-house-sofas-poltronas-roma-03.jpg" class="mautomargin img-responsive" alt="Owl Image">
                                    
                                        <div class="overlay">
                                            <div class="overlay-content text-center">
                                                <h4 class="whiteclr">De R$ 2.000,00 por<br>só 10 x de R$ 69,90</h4>	
                                                
                                                <a href="detalhes-sofas-poltronas-komfort-house.php?id=63"  class=" whiteclr">
                                                    <div  class="plus text-right">
                                                        <span class="fsize18">saiba</span><span class="fsize16"><i class="fa fa-plus "></i></span>
                                                    </div>
                                                </a>		
                   ...
                   <!-- <div class="col-md-3 col-sm-6 col-xs-12 space10">
						<div class="item">
						<h3>Destaque 1</h3>
							<div class="image">
								
								<img src="image/sofa20.jpg" class="mautomargin img-responsive" alt="Owl Image">
							
								<div class="overlay">
									<div class="overlay-content text-center">
										<h4 class="whiteclr">Conheca nossa linha completa de sofas.</h4>	
										
										<a href=""  class=" whiteclr">
											<div  class="plus text-right">
												<span class="fsize18">saiba</span><span class="fsize16"><i class="fa fa-plus "></i></span>
											</div>
										</a>		
